...
const handleCallback = (url: string) => {
  ...
  <div className="relative w-full max-w-3xl rounded-2xl overflow-hidden bg-white shadow-xl">
    ...
    <div className="relative flex flex-col md:flex-row bg-blue-600 text-white p-6 md:p-8 gap-6">
      <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-16 translate-x-16"></div>
      <div className="absolute bottom-0 left-0 w-20 h-20 bg-white/10 rounded-full translate-y-12 -translate-x-10"></div>
...
<div className="bg-white px-6 py-5 rounded-b-2xl shadow-inner hidden md:block ">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div className="group relative  rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-sky-50 p-6 shadow-sm hover:shadow-xl transition-all duration-300">
      <div className="absolute -top-4 -left-4 bg-sky-100 text-blue-600 px-3 py-1 rounded border group-hover:-rotate-12 text-xs font-semibold shadow-sm">
       ACE CMS
      </div>
     ...
     {t('feature1')}
      ...
      <Link
        ...
        className=" text-sm font-semibold text-blue-600 hover:text-blue-800 transition-colors flex gap-1"
      >
    ...
    <div className="group relative rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-sky-50 p-6 shadow-sm hover:shadow-xl transition-all duration-300">
      <div className="absolute -top-4 -left-4 bg-sky-100 text-blue-600 px-3 py-1 border rounded group-hover:-rotate-12 text-xs font-semibold shadow-sm">
       ACE CRM
      </div>
      <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors duration-300">
      {t('feature2')}
      ...
      <Link
        ...
        className="flex text-sm font-semibold text-blue-600 hover:text-blue-800 transition-colors gap-1"
      >
        {t('LearnMore')} <FaArrowRightLong className='mt-1'/>
      </Link>
    </div>
